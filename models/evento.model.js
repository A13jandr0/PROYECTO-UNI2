...
const historialEstadoSchema = new mongoose.Schema({
  estadoAnterior: {
    type: String,
    enum: ['borrador', 'publicado', 'en_curso', 'finalizado', 'suspendido', 'cancelado','absorbido']
  },
  estadoNuevo: {
    type: String,
    enum: ['borrador', 'publicado', 'en_curso', 'finalizado', 'suspendido', 'cancelado','absorbido'],
...
const eventoSchema = new mongoose.Schema({
  ...
  megaEventoId: {
    type: Number,
    index: true,
    sparse: true  // permite que no todos los documentos lo tengan
  },

  imagenesInvitados: [{
    invitadoIdSQL: Number,      // el id en SQL Server
    datos: Buffer,              // o String si lo guardas en base64
    mimeType: String,
